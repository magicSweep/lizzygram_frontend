...
/* const tagsData = getBuildFor() === "portfolio" ? pTagsData : lTagsData;

const state = getBuildFor() === "portfolio" ? pTagsState : lTagsState;

const defaultTags = getBuildFor() === "portfolio" ? pDefaultTags : lDefaultTags; */

export const getTagsData = (buildFor: BuildFor = "lizzygram") =>
  buildFor === "portfolio" ? pTagsData : lTagsData;

export const getTagsState = (buildFor: BuildFor = "lizzygram") =>
  buildFor === "portfolio" ? pTagsState : lTagsState;

export const getDefaultTags = (buildFor: BuildFor = "lizzygram") =>
  buildFor === "portfolio" ? pDefaultTags : lDefaultTags;
